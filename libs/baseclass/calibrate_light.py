...
class CalibrateLight(Screen):
    ...
    def on_enter(self, *args):
        ...
        self.figure_wgt3.xmin= np.min(self.wave[0])
        self.figure_wgt3.xmax = np.max(self.wave[0])
    ...
    def update_graph(self,_):
        xdata= self.wave[0]
        self.figure_wgt3.line1.set_data(xdata,self.get_all_spec[self.i])
        self.figure_wgt3.ymax = np.max(self.get_all_spec[self.i])
        self.figure_wgt3.ymin = np.min(self.get_all_spec[self.i])
